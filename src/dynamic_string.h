...
// @return - status code
Status_t d_string_init(DString_t *d_string);

// Frees dynamic string
// @param d_string - pointer to dynamic string
// @return - status code
Status_t d_string_free(DString_t *d_string);

// Adds character to dynamic string
// @param d_string - pointer to dynamic string
// @param c - character to be added
// @return - status code
Status_t d_string_add_char(DString_t *d_string, char c);

// Appends dynamic string by another constant string
// @param d_string - pointer to dynamic string
// @param c_str - string to be added
// @return - status code
Status_t d_string_add_str(DString_t *d_string, const char *c_str);
...
// @return - status code
Status_t d_string_add_d_str(DString_t *d_string, const DString_t *d_str);

// Clears dynamic string
// @param d_string - pointer to dynamic string
// @return - status code
Status_t d_string_clear(DString_t *d_string);

// Compares dynamic string with constant string
// @param d_string - pointer to dynamic string
// @param c_str - string to be compared with
// @return - status code
Status_t d_string_cmp(DString_t *d_string, const char *c_str);
...
// @return - status code
Status_t d_string_copy(DString_t *src, DString_t *dest);
