...
/**
 * @brief Part of FSM implemetation, returns FSM STATE according to current
 * state and input char
 *
...
/**
 * @brief Function that returns the token through the pointer and returns if the
 * token is valid
 *
 * @param token - pointer to token
